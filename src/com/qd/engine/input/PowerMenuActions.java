    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for (String action : mAllActions) {
            ...
            if (action.equals(GLOBAL_ACTION_KEY_REBOOT)) { 
                ...
                mVoicePref = (CheckBoxPreference) findPreference(GLOBAL_ACTION_KEY_VOICEASSIST );
            } else if (action.equals(GLOBAL_ACTION_KEY_ASSIST)) {
                mAssistPref = (CheckBoxPreference) findPreference(GLOBAL_ACTION_KEY_ASSIST);
